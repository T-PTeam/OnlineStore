...
namespace OnlineStore.Web.Controllers.Domain.Carts;

public class CartController : Controller
{
    private readonly IOnlineStoreClient _onlineStoreClient;

    public CartController(IOnlineStoreClient onlineStoreClient)
    {
    ...
    {
        var product = await _onlineStoreClient.GetProductByIdAsync(id);
